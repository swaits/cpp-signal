...
public:
	 ...
	 */
	virtual bool operator== (const Slot4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>* other) const = 0;
	 ...
	 */
	virtual Slot4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 4 parameter(s).
 */
template <typename T_return, typename T_arg0, typename T_arg1, typename T_arg2, typename T_arg3>
class SlotFunction4 : public Slot4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>
{
public:
	 ...
	 */
	typedef Slot4<T_return, T_arg0, T_arg1, T_arg2, T_arg3> SlotBase;
	 ...
	 */
	SlotFunction4 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	 ...
	 */
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const
	{
		return pFunction(a0, a1, a2, a3);
	}
	...
	{
		const SlotFunction4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>* pother = dynamic_cast<const SlotFunction4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction4* copy = new SlotFunction4(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 4 parameter(s).
 */
...
class SlotMember4 : public Slot4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember4 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const
	{
		return (pObject->*pMember)(a0, a1, a2, a3);
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember4<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3>* pother = dynamic_cast<const SlotMember4<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember4* copy = new SlotMember4(pObject,pMember);
		return copy;
	}
...
public:
	 ...
	 */
	Signal4(const Signal4& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal4<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	 ...
	 */
	Signal4& operator= (const Signal4& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal4<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal4<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3))
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3))
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 * Calls all slots connected to this signal.
	 */
	void Emit(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3)
	{
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction4<T_return, T_arg0, T_arg1, T_arg2, T_arg3>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember4<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember4<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember4<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3>(object, method) );
	}
