...
public:
	 ...
	 */
	virtual bool operator== (const Slot9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>* other) const = 0;
	 ...
	 */
	virtual Slot9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 9 parameter(s).
 */
template <typename T_return, typename T_arg0, typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4, typename T_arg5, typename T_arg6, typename T_arg7, typename T_arg8>
class SlotFunction9 : public Slot9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>
{
public:
	 ...
	 */
	typedef Slot9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8> SlotBase;
	 ...
	 */
	SlotFunction9 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	 ...
	 */
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const
	{
		return pFunction(a0, a1, a2, a3, a4, a5, a6, a7, a8);
	}
	...
	{
		const SlotFunction9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>* pother = dynamic_cast<const SlotFunction9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction9* copy = new SlotFunction9(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 9 parameter(s).
 */
...
class SlotMember9 : public Slot9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember9 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const
	{
		return (pObject->*pMember)(a0, a1, a2, a3, a4, a5, a6, a7, a8);
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember9<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>* pother = dynamic_cast<const SlotMember9<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember9* copy = new SlotMember9(pObject,pMember);
		return copy;
	}
...
public:
	 ...
	 */
	Signal9(const Signal9& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal9<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	 ...
	 */
	Signal9& operator= (const Signal9& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal9<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal9<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8))
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8))
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 * Calls all slots connected to this signal.
	 */
	void Emit(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4, T_arg5 a5, T_arg6 a6, T_arg7 a7, T_arg8 a8)
	{
		...
		{
			// call slot
			(*(current->slot))(a0, a1, a2, a3, a4, a5, a6, a7, a8);
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction9<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember9<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember9<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember9<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4, T_arg5, T_arg6, T_arg7, T_arg8>(object, method) );
	}
