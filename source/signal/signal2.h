...
public:
	 ...
	 */
	virtual bool operator== (const Slot2<T_return, T_arg0, T_arg1>* other) const = 0;
	 ...
	 */
	virtual Slot2<T_return, T_arg0, T_arg1>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 2 parameter(s).
 */
template <typename T_return, typename T_arg0, typename T_arg1>
class SlotFunction2 : public Slot2<T_return, T_arg0, T_arg1>
{
public:
	 ...
	 */
	typedef Slot2<T_return, T_arg0, T_arg1> SlotBase;
	 ...
	 */
	SlotFunction2 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	 ...
	 */
	virtual T_return operator() (T_arg0 a0, T_arg1 a1) const
	{
		return pFunction(a0, a1);
	}
	...
	{
		const SlotFunction2<T_return, T_arg0, T_arg1>* pother = dynamic_cast<const SlotFunction2<T_return, T_arg0, T_arg1>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction2* copy = new SlotFunction2(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 2 parameter(s).
 */
template <class T_object, typename T_member, typename T_return, typename T_arg0, typename T_arg1>
class SlotMember2 : public Slot2<T_return, T_arg0, T_arg1>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember2 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember2<T_object,T_member,T_return, T_arg0, T_arg1>* pother = dynamic_cast<const SlotMember2<T_object,T_member,T_return, T_arg0, T_arg1>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember2* copy = new SlotMember2(pObject,pMember);
		return copy;
	}
...
public:
	...
	Signal2(const Signal2& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal2<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	...
	Signal2& operator= (const Signal2& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal2<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal2<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1) const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1) const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1))
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1) const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1))
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1) const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction2<T_return, T_arg0, T_arg1>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction2<T_return, T_arg0, T_arg1>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction2<T_return, T_arg0, T_arg1>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember2<T_object, T_member, T_return, T_arg0, T_arg1>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember2<T_object, T_member, T_return, T_arg0, T_arg1>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember2<T_object, T_member, T_return, T_arg0, T_arg1>(object, method) );
	}
