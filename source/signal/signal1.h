...
public:
	 ...
	 */
	virtual bool operator== (const Slot1<T_return, T_arg0>* other) const = 0;
	 ...
	 */
	virtual Slot1<T_return, T_arg0>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 1 parameter(s).
 */
template <typename T_return, typename T_arg0>
class SlotFunction1 : public Slot1<T_return, T_arg0>
{
public:
	 ...
	 */
	typedef Slot1<T_return, T_arg0> SlotBase;
	 ...
	 */
	SlotFunction1 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	 ...
	 */
	virtual T_return operator() (T_arg0 a0) const
	{
		return pFunction(a0);
	}
	...
	{
		const SlotFunction1<T_return, T_arg0>* pother = dynamic_cast<const SlotFunction1<T_return, T_arg0>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction1* copy = new SlotFunction1(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 1 parameter(s).
 */
template <class T_object, typename T_member, typename T_return, typename T_arg0>
class SlotMember1 : public Slot1<T_return, T_arg0>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember1 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember1<T_object,T_member,T_return, T_arg0>* pother = dynamic_cast<const SlotMember1<T_object,T_member,T_return, T_arg0>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember1* copy = new SlotMember1(pObject,pMember);
		return copy;
	}
...
public:
	...
	Signal1(const Signal1& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal1<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	...
	Signal1& operator= (const Signal1& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal1<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal1<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0) const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0) const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0))
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0) const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0))
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0) const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction1<T_return, T_arg0>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction1<T_return, T_arg0>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction1<T_return, T_arg0>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember1<T_object, T_member, T_return, T_arg0>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember1<T_object, T_member, T_return, T_arg0>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember1<T_object, T_member, T_return, T_arg0>(object, method) );
	}
