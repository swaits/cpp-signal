...
public:
	 ...
	 */
	virtual bool operator== (const Slot0<T_return>* other) const = 0;
	 ...
	 */
	virtual Slot0<T_return>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 0 parameter(s).
 */
template <typename T_return>
class SlotFunction0 : public Slot0<T_return>
{
public:
	 ...
	 */
	typedef Slot0<T_return> SlotBase;
	 ...
	 */
	SlotFunction0 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	...
	{
		const SlotFunction0<T_return>* pother = dynamic_cast<const SlotFunction0<T_return>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction0* copy = new SlotFunction0(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 0 parameter(s).
 */
template <class T_object, typename T_member, typename T_return>
class SlotMember0 : public Slot0<T_return>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember0 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember0<T_object,T_member,T_return>* pother = dynamic_cast<const SlotMember0<T_object,T_member,T_return>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember0* copy = new SlotMember0(pObject,pMember);
		return copy;
	}
...
public:
	...
	Signal0(const Signal0& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal0<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	...
	Signal0& operator= (const Signal0& other)
	{
		...
		if ( emitting )
		{
			printf("ERROR!: Signal0<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal0<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)() const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)() const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)())
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)() const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)())
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)() const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)())
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)() const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)())
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)() const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction0<T_return>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction0<T_return>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction0<T_return>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember0<T_object, T_member, T_return>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember0<T_object, T_member, T_return>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember0<T_object, T_member, T_return>(object, method) );
	}
