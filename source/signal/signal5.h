...
public:
	 ...
	 */
	virtual bool operator== (const Slot5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>* other) const = 0;
	 ...
	 */
	virtual Slot5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>* clone() const = 0;
...
/**
 * Concrete slot class for calling a global function with 5 parameter(s).
 */
template <typename T_return, typename T_arg0, typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4>
class SlotFunction5 : public Slot5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>
{
public:
	 ...
	 */
	typedef Slot5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4> SlotBase;
	 ...
	 */
	SlotFunction5 (FUNCTION_POINTER func):
		pFunction(func)
	{ 
	}
	 ...
	 */
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const
	{
		return pFunction(a0, a1, a2, a3, a4);
	}
	...
	{
		const SlotFunction5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>* pother = dynamic_cast<const SlotFunction5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>*>(other);
		if ( pother )
		{
	...
	{
		SlotFunction5* copy = new SlotFunction5(pFunction);
		return copy;
	}
...
/**
 * Concrete slot class for calling a member function with 5 parameter(s).
 */
...
class SlotMember5 : public Slot5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>
{
public:
	 ...
	 * @param func   function pointer to be called by this slot.
	 */
	SlotMember5 (T_object* c, T_member m):
		pObject(c),
		pMember(m)
	{ 
	}
	...
	virtual T_return operator() (T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const
	{
		return (pObject->*pMember)(a0, a1, a2, a3, a4);
	}
	...
	virtual bool operator== (const SlotBase* other) const
	{
		const SlotMember5<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>* pother = dynamic_cast<const SlotMember5<T_object,T_member,T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>*>(other);
		if ( pother )
		{
	...
	virtual SlotBase* clone() const
	{
		SlotMember5* copy = new SlotMember5(pObject,pMember);
		return copy;
	}
...
public:
	 ...
	 */
	Signal5(const Signal5& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal5<...> @ 0x%p is being copy constructed during Emit!\n",this);
		}
#endif
	 ...
	 */
	Signal5& operator= (const Signal5& other)
	{
#if defined(_DEBUG)
		if ( emitting )
		{
			printf("ERROR!: Signal5<...> @ 0x%p is being assigned during Emit!\n",this);
		}
#endif
	...
	{		
		...
		if ( !Empty() )
		{
			printf("WARNING: Signal5<...> @ 0x%p destroyed with %d slots still connected!\n",this,Count());
		}
#endif
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object>
	bool Connect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const, int lifetime = -1)
	{
		return connect_member(object, method,lifetime);
	}
	...
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4), int lifetime = -1)
	{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Connect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const, int lifetime = -1)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4))
	{
	 ...
	 */
	template <typename T_object>
	bool Disconnect(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const)
	{
		return disconnect_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool Disconnect(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4))
	{
	 ...
	 */
	template <typename T_object>
	bool IsConnected(T_object* object, T_return (T_object::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const)
	{
		return search_member(object, method);
	}
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4))
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 */
	template <typename T_object, typename T_parent>
	bool IsConnected(T_object* object, T_return (T_parent::*method)(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4) const)
	{
		T_parent* ancestor = dynamic_cast<T_parent*>(object);
		if ( ancestor )
		{
	 ...
	 * Calls all slots connected to this signal.
	 */
	void Emit(T_arg0 a0, T_arg1 a1, T_arg2 a2, T_arg3 a3, T_arg4 a4)
	{
...
private:
	...
	bool connect_function(FUNCTION_POINTER func, int lifetime)
	{
		...
		return connect_slot( SlotFunction5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(func), lifetime );
	}
	...
	bool disconnect_function(FUNCTION_POINTER func)
	{
		...
		return disconnect_slot( SlotFunction5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(func) );
	}
	...
	{
		// create temp slot and attempt disconnect
		return search_slot( SlotFunction5<T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(func) );
	}
	...
	{
		// create temp slot and attempt connect
		return connect_slot( SlotMember5<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(object, method), lifetime );
	}
	...
	{
		// create temp slot and attempt disconnect
		return disconnect_slot( SlotMember5<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(object, method) );
	}
	...
	bool search_member(T_object* object, T_member method)
	{
		...
		return search_slot( SlotMember5<T_object, T_member, T_return, T_arg0, T_arg1, T_arg2, T_arg3, T_arg4>(object, method) );
	}
